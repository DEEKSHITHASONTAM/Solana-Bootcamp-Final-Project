...
pub fn mint(
	...
	cryptopuzzle: &mut AccountPDA<PuzzleMetadata>,
	funding: &AccountInfo,
    ...
    cryptopuzzle.data.puzzle = puzzle;
    cryptopuzzle.data.description = description;
    cryptopuzzle.data.hint = hint;
    cryptopuzzle.data.mint = *mint.info.key;
    cryptopuzzle.data.assoc_account = Some(*assoc_token_account.key);
