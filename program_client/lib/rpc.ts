 ...
 * 2. `[writable]` cryptopuzzle: {@link PuzzleMetadata} 
 ...
 * 2. `[writable]` puzzle_art: {@link PuzzleMetadata} 
...
export const mint = (args: MintArgs): TransactionInstruction => {
    ...
    const [cryptopuzzlePubkey] = pda.derivePuzzleMetadataPDA({
        mint: args.mint,
    }, _programId);
    ...
    return new TransactionInstruction({
        ...
        keys: [
            ...
            {pubkey: cryptopuzzlePubkey, isSigner: false, isWritable: true},
...
export const burn = (args: BurnArgs): TransactionInstruction => {
    ...
    const [puzzleArtPubkey] = pda.derivePuzzleMetadataPDA({
        mint: args.mint,
    }, _programId);
    ...
    return new TransactionInstruction({
        ...
        keys: [
            ...
            {pubkey: puzzleArtPubkey, isSigner: false, isWritable: true},
...
export const getPuzzleMetadata = async (
    publicKey: PublicKey,
    commitmentOrConfig: Commitment | GetAccountInfoConfig | undefined = "processed"
): Promise<T.PuzzleMetadata | undefined> => {
    ...
    return T.decodePuzzleMetadata(deserialize(T.PuzzleMetadataSchema, buffer.data) as Record<string, unknown>);
}
